import CJS_COMPAT_NODE_URL_p6dx8ym9vjp from 'node:url';
import CJS_COMPAT_NODE_PATH_p6dx8ym9vjp from 'node:path';
import CJS_COMPAT_NODE_MODULE_p6dx8ym9vjp from "node:module";

var __filename = CJS_COMPAT_NODE_URL_p6dx8ym9vjp.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_p6dx8ym9vjp.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_p6dx8ym9vjp.createRequire(import.meta.url);
...
import {
  toEstree
} from "../_node-chunks/chunk-AV7ODRN4.js";
import {
  StatusTypeIdMismatchError
} from "../_node-chunks/chunk-M2E4L6QV.js";
import {
  debounce,
  generateStoryFile,
  getErrorLevel,
  ...
  useStatics,
  withTelemetry
} from "../_node-chunks/chunk-GW26M2QI.js";
import {
  detectPnp
} from "../_node-chunks/chunk-JW3FM3PO.js";
import "../_node-chunks/chunk-7XBFFTF6.js";
import {
  StorybookError
} from "../_node-chunks/chunk-N566H3BO.js";
import {
  telemetry
} from "../_node-chunks/chunk-ISANGN5J.js";
import "../_node-chunks/chunk-DHSVTLVJ.js";
import {
...
} from "../_node-chunks/chunk-BL76H6BS.js";
import "../_node-chunks/chunk-ATF6YCRL.js";
import "../_node-chunks/chunk-NWXGLC75.js";
import {
  logger,
  require_pretty_hrtime
} from "../_node-chunks/chunk-KHTDDGOW.js";
import "../_node-chunks/chunk-AGJYR5ZD.js";
import "../_node-chunks/chunk-UR6MAPFP.js";
import {
  invariant,
  up2 as up
} from "../_node-chunks/chunk-LFYJMNAU.js";
import "../_node-chunks/chunk-TN4S6HTX.js";
import {
  importModule,
  resolvePackageDir
} from "../_node-chunks/chunk-5QCKF7SG.js";
import {
  dirname,
  isAbsolute,
  join,
  relative,
  resolve
} from "../_node-chunks/chunk-D6VMYSTQ.js";
import {
  slash
} from "../_node-chunks/chunk-ASOXY63E.js";
import "../_node-chunks/chunk-GEOY3LGC.js";
import {
  Tag
} from "../_node-chunks/chunk-QK55I4BK.js";
import {
  require_dist
} from "../_node-chunks/chunk-NUBDB567.js";
import {
  require_lib,
  require_src
} from "../_node-chunks/chunk-QLEKU7Z3.js";
import {
  require_picocolors
} from "../_node-chunks/chunk-LI25JRNF.js";
import {
  __commonJS,
  __require,
  __toESM
} from "../_node-chunks/chunk-DTW6SUQA.js";
...
async function getManagerBuilder() {
  return await import("../_node-chunks/builder-manager-RIBA45WN.js");
}
  ...
  async function onChangeOrRemove(absolutePath, removed) {
    ...
    !removed && isDirectory(absolutePath) && await Promise.all(
      specifiers.filter((specifier) => importPath.startsWith(specifier.directory)).map(async (specifier) => {
        ...
        ), { globby } = await import("../_node-chunks/globby-Z6HTDFCE.js");
...
var getAttr = (elt, what) => elt.attributes.find((n) => n.type === "JSXAttribute" && n.name.name === what), getAttrValue = (elt, what) => getAttr(elt, what)?.value, getAttrLiteral = (elt, what) => {
  ...
  let store = {
    ...
    metaTags: void 0,
    imports: void 0
  }, { compile } = await import("../_node-chunks/mdx-N42X6CFJ-DJXEHK43.js");
  await compile(code, {
...
var makeAbsolute = (otherImport, normalizedPath, workingDir) => otherImport.startsWith(".") ? slash(resolve3(workingDir, normalizeStoryPath(join5(dirname2(normalizedPath), otherImport)))) : otherImport, StoryIndexGenerator = class _StoryIndexGenerator {
  ...
  static async findMatchingFiles(specifier, workingDir, ignoreWarnings = !1) {
    ...
    if (cached)
      return cached;
    let pathToSubIndex = {}, globCwd = slash(resolve3(workingDir, specifier.directory)), globPattern = specifier.files.startsWith("!") ? `./${specifier.files}` : specifier.files, { globby } = await import("../_node-chunks/globby-Z6HTDFCE.js"), files = await globby(globPattern, {
      absolute: !0,
      cwd: globCwd,
