...
import {
  compile
} from "./chunk-3JLHRAIZ.js";
import "./chunk-SACWH4DC.js";
import "./chunk-22FCS527.js";
import {
  __commonJS,
  __toESM
} from "./chunk-TZNU6STR.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-SWZMHUUR.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-SCPKU2WJ.js")).default;
  return {
