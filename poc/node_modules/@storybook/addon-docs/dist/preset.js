import CJS_COMPAT_NODE_URL_27xqi6dcypk from 'node:url';
import CJS_COMPAT_NODE_PATH_27xqi6dcypk from 'node:path';
import CJS_COMPAT_NODE_MODULE_27xqi6dcypk from "node:module";

var __filename = CJS_COMPAT_NODE_URL_27xqi6dcypk.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_27xqi6dcypk.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_27xqi6dcypk.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-TZNU6STR.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-SWZMHUUR.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-SCPKU2WJ.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-DEZUCL6O.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
