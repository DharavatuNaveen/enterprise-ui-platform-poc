import CJS_COMPAT_NODE_URL_4sr29cj5g6 from 'node:url';
import CJS_COMPAT_NODE_PATH_4sr29cj5g6 from 'node:path';
import CJS_COMPAT_NODE_MODULE_4sr29cj5g6 from "node:module";

var __filename = CJS_COMPAT_NODE_URL_4sr29cj5g6.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_4sr29cj5g6.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_4sr29cj5g6.createRequire(import.meta.url);
...
import {
  any
} from "./_node-chunks/chunk-ZWJSGW7O.js";
import {
  DOCUMENTATION_LINK
} from "./_node-chunks/chunk-2HCJRW36.js";
import {
  require_dist
} from "./_node-chunks/chunk-KYCLSO7U.js";
import {
  dirname,
  normalize,
  relative,
  resolve
} from "./_node-chunks/chunk-O6N7CUA5.js";
import {
  require_compare,
  require_constants,
  require_debug,
  ...
  require_re,
  require_semver
} from "./_node-chunks/chunk-KS7CB3NN.js";
import {
  __commonJS,
  __toESM
} from "./_node-chunks/chunk-BC5YAGS5.js";
...
async function getTemplatePath(name) {
  switch (name) {
    case "vitest.config.template":
      return import("./_node-chunks/vitest.config-GOYF2ZMV.js");
    case "vitest.config.4.template":
      return import("./_node-chunks/vitest.config.4-EGEUYE4R.js");
    case "vitest.config.3.2.template":
      return import("./_node-chunks/vitest.config.3.2-FJR5F2GR.js");
    case "vitest.workspace.template":
      return import("./_node-chunks/vitest.workspace-BDIYD6ZT.js");
    default:
