...
<head>
    <title>Code coverage report for src/components/spinner.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/components</a> spinner.ts</h1>
        <div class='clearfix'>
  ...
  render() {
    return html`
      &lt;div
        ...
        style="${this.color ? <span class="branch-0 cbranch-no" title="branch not covered" >`--org-spinner-color: ${this.color}` : '</span>'}"
      &gt;
...
export <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >class O</span></span>rgSkeleton extends LitElement {
&nbsp;
  @property({ type: String })
<span class="cstat-no" title="statement not covered" >  variant: 'text' | 'circle' | 'rect' | 'card' = 'text';</span>
&nbsp;
  @property({ type: String })
...
<span class="cstat-no" title="statement not covered" >  lines = 3;</span>
&nbsp;
  @property({ type: Boolean })
<span class="cstat-no" title="statement not covered" >  animated = true;</span>
&nbsp;
  static styles = css`
...
<span class="fstat-no" title="function not covered" >  render() {</span>
    const animClass = <span class="cstat-no" title="statement not covered" >this.animated ? 'animated' : '';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.variant === 'text') {</span>
<span class="cstat-no" title="statement not covered" >      return html`</span>
        &lt;div class="text-lines"&gt;
          ${Array.from({ length: this.lines }, <span class="fstat-no" title="function not covered" >(_</span>, i) =&gt; <span class="cstat-no" title="statement not covered" >html`</span>
            &lt;div
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.variant === 'circle') {</span>
      const sz = <span class="cstat-no" title="statement not covered" >this.width || this.height || '40px';</span>
<span class="cstat-no" title="statement not covered" >      return html`</span>
        &lt;div
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.variant === 'card') {</span>
<span class="cstat-no" title="statement not covered" >      return html`</span>
