...
<head>
    <title>Code coverage report for src/components/input.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/components</a> input.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { LitElement, html, css, nothing } from 'lit';
...
&nbsp;
  ...
  `;
&nbsp;
  get <span class="fstat-no" title="function not covered" >validity() {</span> <span class="cstat-no" title="statement not covered" >return this._internals.validity; }</span>
  get <span class="fstat-no" title="function not covered" >validationMessage() {</span> <span class="cstat-no" title="statement not covered" >return this._internals.validationMessage; }</span>
&nbsp;
<span class="fstat-no" title="function not covered" >  focus() {</span> <span class="cstat-no" title="statement not covered" >this._input?.focus(); }</span>
<span class="fstat-no" title="function not covered" >  blur()  {</span> <span class="cstat-no" title="statement not covered" >this._input?.blur(); }</span>
&nbsp;
  private <span class="fstat-no" title="function not covered" >_onInput(e</span>: Event) {
    const input = <span class="cstat-no" title="statement not covered" >e.target as HTMLInputElement;</span>
<span class="cstat-no" title="statement not covered" >    this.value = input.value;</span>
<span class="cstat-no" title="statement not covered" >    this._internals.setFormValue(this.value);</span>
<span class="cstat-no" title="statement not covered" >    this.dispatchEvent(new CustomEvent('org-input:input', {</span>
      bubbles: true, composed: true, detail: { value: this.value }
    }));
  }
&nbsp;
  private <span class="fstat-no" title="function not covered" >_onChange(e</span>: Event) {
    const input = <span class="cstat-no" title="statement not covered" >e.target as HTMLInputElement;</span>
<span class="cstat-no" title="statement not covered" >    this.value = input.value;</span>
<span class="cstat-no" title="statement not covered" >    this.dispatchEvent(new CustomEvent('org-input:change', {</span>
      bubbles: true, composed: true, detail: { value: this.value }
    }));
  }
&nbsp;
  private <span class="fstat-no" title="function not covered" >_onFocus() {</span>
<span class="cstat-no" title="statement not covered" >    this._focused = true;</span>
<span class="cstat-no" title="statement not covered" >    this.dispatchEvent(new CustomEvent('org-input:focus', { bubbles: true, composed: true }));</span>
  }
&nbsp;
  private <span class="fstat-no" title="function not covered" >_onBlur() {</span>
<span class="cstat-no" title="statement not covered" >    this._focused = false;</span>
<span class="cstat-no" title="statement not covered" >    this.dispatchEvent(new CustomEvent('org-input:blur', { bubbles: true, composed: true }));</span>
  }
&nbsp;
  private get _wrapperClass() {
    const classes = ['input-wrapper'];
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.error)    <span class="cstat-no" title="statement not covered" >classes.push('error');</span>
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.success &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!this.error)  <span class="cstat-no" title="statement not covered" >c</span>lasses.push('success');</span>
...
&nbsp;
  render() {
    ...
    const helperType = this.error ? <span class="branch-0 cbranch-no" title="branch not covered" >'error' : t</span>his.success ? <span class="branch-0 cbranch-no" title="branch not covered" >'success' : '</span>';
&nbsp;
    return html`
      &lt;div class="container ${this._containerClass}" part="container"&gt;
&nbsp;
        ${this.label ? <span class="branch-0 cbranch-no" title="branch not covered" >html`</span>
          &lt;label part="label"&gt;
            ${this.label}
...
&nbsp;
        &lt;div class="${this._wrapperClass}"&gt;
          &lt;span class="slot-prefix"&gt;
            &lt;slot name="prefix" @slotchange="${<span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" >t</span>his.requestUpdate()}</span>"&gt;&lt;/slot&gt;
          &lt;/span&gt;
&nbsp;
          &lt;input
            part="input"
            ...
            maxlength="${this.maxlength ?? <span class="branch-1 cbranch-no" title="branch not covered" >nothing}</span>"
            minlength="${this.minlength ?? <span class="branch-1 cbranch-no" title="branch not covered" >nothing}</span>"
            pattern="${this.pattern || nothing}"
            autocomplete="${this.autocomplete || nothing}"
            aria-invalid="${this.error ? <span class="branch-0 cbranch-no" title="branch not covered" >'true' : n</span>othing}"
            aria-describedby="${helperMsg ? <span class="branch-0 cbranch-no" title="branch not covered" >'helper' : n</span>othing}"
            @input="${this._onInput}"
...
&nbsp;
        &lt;div style="display:flex; align-items:center;"&gt;
          ${helperMsg ? <span class="branch-0 cbranch-no" title="branch not covered" >html`</span>
...
&nbsp;
          ${this.maxlength !== undefined ? html`
            &lt;span class="char-count ${overLimit ? <span class="branch-0 cbranch-no" title="branch not covered" >'over' : '</span>'}"&gt;
              ${charCount}/${this.maxlength}
            &lt;/span&gt;
          ` : <span class="branch-1 cbranch-no" title="branch not covered" >nothing}</span>
        &lt;/div&gt;
&nbsp;
      &lt;/div&gt;
    `;
