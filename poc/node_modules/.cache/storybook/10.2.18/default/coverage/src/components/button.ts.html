...
<head>
    <title>Code coverage report for src/components/button.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/components</a> button.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  ...
  `;
&nbsp;
  private <span class="fstat-no" title="function not covered" >handleClick(e</span>: MouseEvent) {
<span class="cstat-no" title="statement not covered" >    if (this.disabled || this.loading) {</span>
...
<span class="cstat-no" title="statement not covered" >    this.dispatchEvent(new CustomEvent('org-button:click', {</span>
      bubbles: true,
      composed: true,
  ...
  render() {
    return html`
      &lt;button
        ...
        aria-busy="${this.loading ? <span class="branch-0 cbranch-no" title="branch not covered" >'true' : n</span>othing}"
        type="${this.type}"
        @click="${this.handleClick}"
      &gt;
        ${this.loading
          ? <span class="branch-0 cbranch-no" title="branch not covered" >html`&lt;span class="spinner" aria-hidden="true"&gt;&lt;/span&gt;`</span>
